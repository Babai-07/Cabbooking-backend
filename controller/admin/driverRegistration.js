...
exports.registration = async (req, res) => {
  ...
  try {
    ...
    const insertQuery = `INSERT INTO user (name, email, phone, password, role) VALUES('${name}','${email}','${phone}','${ePassword}', '2')`;
    ...
    const token = await jwt.sign({ name: name, role: 2 }, process.env.JWT_KEY);
